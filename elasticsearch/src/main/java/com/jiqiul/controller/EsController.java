package com.jiqiul.controller;

import com.alibaba.fastjson.JSONObject;
import com.jiqiul.domain.EsModel;
import com.jiqiul.domain.EsPage;
import com.jiqiul.util.ElasticsearchUtil;
...
public class EsController {
    ...
    /**
     * http://127.0.0.1:8080/es/createIndex?indexName=?
     * 创建索引
     * @return
     */
    @RequestMapping("/createIndex")
    @ResponseBody
    public String createIndex(@RequestParam(name = "indexName") String indexName) {
    ...
    @ResponseBody
    public String insertJson(@RequestParam(name = "indexName") String indexName) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("id", DateUtil.getBeforeYesterday());
    ...
    @ResponseBody
    public String insertModel(@RequestParam(name = "indexName") String indexName) {
    ...
    public String queryDateRangeData() {
        ...
        List<Map<String, Object>> list = ElasticsearchUtil.searchListData(indexName, esType, boolQuery, 10, "name", null, null);
        return JSONObject.toJSONString(list);
    }
