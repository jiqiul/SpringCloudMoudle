...
public class DateUtil {
	...
	public static void main(String[] args) throws ParseException {
		// System.out.println(DateUtil.format(DateUtil.addDay(new Date(),
		// -28)));
		SimpleDateFormat format1 = new SimpleDateFormat("HHmmss");
		SimpleDateFormat format2 = new SimpleDateFormat("HH时mm分");
		Date dt = format1.parse("162225");
		System.out.println(format2.format(dt));
		System.out.println(isLastDayOfMonth(new Date()));

		/*
		 * try { String date = format(parse("20161029", "yyyyMMdd"),
		 * "yyyy年MM月dd日"); System.out.println(date); } catch (ParseException e)
		 ...
		 * String time ="103429";
		 * 
		 * try { String s = format(parse(time, "HHmmss"), "HH:mm");
		 * System.out.println(s); System.out.println("20171101".substring(6,8));
